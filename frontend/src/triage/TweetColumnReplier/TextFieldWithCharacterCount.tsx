...
class TextFieldWithCharacterCount extends React.Component<TComponentProps, IState> {
    ...
    public render() {
        const { characterLimit, onFieldChange, onFieldInvalid, onFieldValid, characterPrefixLength, ...textFieldProps } = this.props
        ...
        return (
            <FormControl fullWidth={true} error={errored} style={{ marginBottom: 8 }}>
                <TextField {...textFieldProps} error={errored} /*inputRef={this.inputRef}*/ onChange={onFieldChange} />
