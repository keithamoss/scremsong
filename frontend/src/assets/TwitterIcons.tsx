...
const Reply = (props: any) => (
  <SvgIcon {...props} viewBox="0 0 65 72">
...
const ReplyWithStyles = (props: any & WithStyles<typeof styles>) => (
  <Reply {...props} className={props.classes.colorPrimary} />
)
export const ReplyIcon = withStyles(styles)(ReplyWithStyles)

const Like = (props: any) => (
  <SvgIcon {...props} viewBox="0 0 54 72">
...
const LikeWithStyles = (props: any & WithStyles<typeof styles>) => (
  <Like {...props} className={props.classes.colorPrimary} />
)
export const LikeIcon = withStyles(styles)(LikeWithStyles)

const Retweet = (props: any) => (
  <SvgIcon {...props} viewBox="0 0 75 72">
...
const RetweetWithStyles = (props: any & WithStyles<typeof styles>) => (
  <Retweet {...props} className={props.classes.colorPrimary} />
)
export const RetweetIcon = withStyles(styles)(RetweetWithStyles)
