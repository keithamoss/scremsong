...
class SettingsDialog extends React.PureComponent<TComponentProps, IState> {
    ...
    public constructor(props: TComponentProps) {
        ...
        this.handleChange = (panel: string) => (event: React.MouseEvent<HTMLElement>, expanded: boolean) => {
            this.setState({
                expanded: expanded ? panel : null,
            })
        }

        this.onChangeSetting = (settingName: string) => (event: React.MouseEvent<HTMLElement>, value: any) => {
            this.props.onChangeSetting(settingName, value)
        }

        this.handleClose = (event: React.MouseEvent<HTMLElement>) => {
    ...
    public render() {
        ...
        return (
            <Dialog aria-labelledby="settings-dialog-title" open={open} onClose={this.handleClose} fullWidth={true} maxWidth="lg">
