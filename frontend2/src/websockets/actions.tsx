...
import { IRateLimitResources } from '../admin_panel/TwitterRateLimitStatus/types'
...
export interface IActionReviewersAssignmentMetadataChanged
  extends Action<typeof WS_REVIEWERS_ASSIGNMENT_METADATA_CHANGED> {
  assignment: IReviewerAssignment
}
...
export interface IActionsTweetsLoadTweets
  extends Action<typeof WS_TWEETS_LOAD_TWEETS>,
    ISocialTweetsAndColumnsResponse {}
